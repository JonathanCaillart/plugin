...
var EPAYNC_DFAULT_MESSAGES = ['CLIENT_300', 'CLIENT_304', 'CLIENT_502', 'PSP_539']; // Use default messages for these errors.
var EPAYNC_RECOVERABLE_ERRORS = [
...
var epayncInitRestEvents = function(KR) {
    KR.onError(function(e) {
        jQuery('#epayncstd_rest_processing').css('display', 'none');
        jQuery('form.checkout').removeClass('processing').unblock();

        // Not recoverable error, reload page after a while.
        if (EPAYNC_RECOVERABLE_ERRORS.indexOf(e.errorCode) === -1) {
            setTimeout(function() {
...
var epayncTranslate = function(code) {
    var lang = EPAYNC_LANGUAGE; // Global variable that contains current language.
    var messages = EPAYNC_ERROR_MESSAGES.hasOwnProperty(lang) ? EPAYNC_ERROR_MESSAGES[lang] : EPAYNC_ERROR_MESSAGES['en'];
