...
class Epaync_Subscriptio_Subscriptions_Handler implements Epaync_Subscriptions_Handler_Interface
{
    /**
     * {@inheritDoc}
    ...
    public function process_subscription_renewal($order, $response)
    {
        ...
        if ($renewal_order_id = (int) $subscription->last_order_id) { // Get last generated order.
            ...
            update_post_meta($renewal_order_id, 'Subscription amount', WC_Gateway_Epaync::display_amount($response->get('sub_amount'), $currency_code));
