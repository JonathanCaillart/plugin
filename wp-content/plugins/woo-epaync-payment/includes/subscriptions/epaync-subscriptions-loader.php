...
class Epaync_Subscriptions_Loader
{
    private static $handlers = array(
        'wc-subscriptions' => 'Epaync_WC_Subscriptions_Subscriptions_Handler',
        'subscriptio' => 'Epaync_Subscriptio_Subscriptions_Handler'
    );
    ...
    public static function getInstance($handler)
    {
        ...
        include_once 'epaync-subscriptions-handler-interface.php';
        include_once "epaync-$handler-subscriptions-handler.php";
