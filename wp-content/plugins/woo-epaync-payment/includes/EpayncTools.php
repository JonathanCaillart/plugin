...
class EpayncTools
{
    public static function get_contrib()
    {
        ...
        return WC_Gateway_Epaync::CMS_IDENTIFIER . '_' . WC_Gateway_Epaync::PLUGIN_VERSION . '/' . $version
            . '/' . EpayncApi::shortPhpVersion();
    }
    ...
    public static function get_transaction_uuid($order)
    {
        ...
        if ($trans_id) {
            $notes = WC_Gateway_Epaync::get_order_notes($order->get_id());
