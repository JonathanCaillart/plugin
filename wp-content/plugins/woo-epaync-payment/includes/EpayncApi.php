...
require_once 'EpayncCurrency.php';
require_once 'EpayncField.php';

if (! class_exists('EpayncApi', false)) {
    ...
    class EpayncApi
    {
         ...
         *
         * @return array[int][EpayncCurrency]
         */
        public static function getSupportedCurrencies()
        {
            $currencies = array(
                array('AUD', '036', 2), array('JPY', '392', 0), array('NZD', '554', 2), array('USD', '840', 2),
                array('XPF', '953', 0)
            );

            $epaync_currencies = array();

            foreach ($currencies as $currency) {
                $epaync_currencies[] = new EpayncCurrency($currency[0], $currency[1], $currency[2]);
            }

            return $epaync_currencies;
        }
        ...
        public static function getCurrencyNumCode($alpha3)
        {
            ...
            return ($currency instanceof EpayncCurrency) ? $currency->getNum() : null;
        }
