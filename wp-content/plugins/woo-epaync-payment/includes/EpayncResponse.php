...
if (! class_exists('EpayncResponse', false)) {
    ...
    class EpayncResponse
    {
         ...
         * @var string
         */
        private $algo = EpayncApi::ALGO_SHA1;
        ...
        /**
         * Constructor for EpayncResponse class.
         ...
         * @param string $algo
         */
        public function __construct($params, $ctx_mode, $key_test, $key_prod, $algo = EpayncApi::ALGO_SHA1)
        {
            $this->rawResponse = $params;
            $this->certificate = trim(($ctx_mode == 'PRODUCTION') ? $key_prod : $key_test);

            if (in_array($algo, EpayncApi::$SUPPORTED_ALGOS)) {
                $this->algo = $algo;
            }
        ...
        {
            return EpayncApi::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        {
            return in_array($this->transStatus, EpayncApi::getSuccessStatuses()) || $this->isPendingPayment();
        }
        ...
        {
            return in_array($this->transStatus, EpayncApi::getPendingStatuses());
        }
        ...
        {
            return in_array($this->transStatus, EpayncApi::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, EpayncApi::getToValidateStatuses());
        }
        ...
        {
            $currency = EpayncApi::findCurrencyByNumCode($this->get('currency'));
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), EpayncApi::$SUPPORTED_ENCODINGS) ?
