...
if (! class_exists('EpayncRequest', false)) {
    ...
    class EpayncRequest
    {
        ...
        {
            // Initialize encoding.
            $this->encoding = in_array(strtoupper($encoding), EpayncApi::$SUPPORTED_ENCODINGS) ?
            ...
            $timestamp = time();
            $this->set('vads_trans_id', EpayncApi::generateTransId($timestamp));
        ...
        {
            $this->requestParameters[$name] = new EpayncField($name, $label, $regex, $required, $length);
        ...
        /**
         * Generate signature from a list of EpayncField.
         *
         * @param array[string][EpayncField] $fields already filtered fields list
         * @param bool $hashed
         * @return string
         */
        private function generateSignature($fields, $hashed = true)
        {
            ...
            return EpayncApi::sign($params, $this->getCertificate(), $this->algo, $hashed);
        }
         ...
         *
         * @return array[string][EpayncField] a list of EpayncField
         */
